 ...
 * Declare programs 
 **/
extern FREQUENCYCOUNTER RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.FREQUENCY_IN), BOOL_ENUM},
{&(RES0__INSTANCE0.FREQUENCY_VALUE), UINT_ENUM},
...
{&(RES0__INSTANCE0.F_AUX_00), INT_ENUM},
{&(RES0__INSTANCE0.F_AUX_01), INT_ENUM},
{&(RES0__INSTANCE0.F_AUX_02), INT_ENUM},
{&(RES0__INSTANCE0.F_AUX_03), INT_ENUM},
{&(RES0__INSTANCE0.F_SUM), INT_ENUM},
{&(RES0__INSTANCE0.F_AVERAGE), REAL_ENUM},
...
{&(RES0__INSTANCE0._TMP_MUL57_OUT), REAL_ENUM},
{&(RES0__INSTANCE0._TMP_REAL_TO_UINT56_OUT), UINT_ENUM},
...
{&(RES0__INSTANCE0._TMP_ADD66_OUT), INT_ENUM},
{&(RES0__INSTANCE0._TMP_INT_TO_REAL73_OUT), REAL_ENUM},
{&(RES0__INSTANCE0._TMP_MUL72_OUT), REAL_ENUM}
};
